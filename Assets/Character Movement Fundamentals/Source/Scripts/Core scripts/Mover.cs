...
namespace CMF
{
	...
	public class Mover : MonoBehaviour {
		...
		public bool poison1InInventory = false;
		public GameObject poison1_img;

		public bool poison2InInventory = false;
		public GameObject poison2;
		public GameObject poison2_img;

		public bool poison3InInventory = false;
		public GameObject poison3;
		public GameObject poison3_img;

		public bool poison4InInventory = false;
		public GameObject poison4;		
		public GameObject poison4_img;
        ...
        private void OnCollisionEnter(Collision collision)
        {
			...
			if (collision.gameObject.tag == "one")
            {
				...
				poison1_img.SetActive(true);
				poison1InInventory = true;

	}
			if (collision.gameObject.tag == "two")
			{
				poison2.SetActive(false);
				poison2_img.SetActive(true);
				poison2InInventory = true;
			}
			if (collision.gameObject.tag == "three")
			{
				poison3.SetActive(false);
				poison3_img.SetActive(true);
				poison3InInventory = true;

			}
			if (collision.gameObject.tag == "four")
			{
				poison4.SetActive(false);
				poison4_img.SetActive(true);
				poison4InInventory = true;

			}

			

			if(poison1InInventory && poison2InInventory && poison3InInventory && poison4InInventory)
            {
        ...
        {
            if(other.gameObject.tag == "ExclaimParticle")
            {
